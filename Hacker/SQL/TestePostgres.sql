...
,CASE 
                WHEN (DEP.IDDEPARTMENT IS NOT NULL) THEN DEP.IDDEPARTMENT + ' - ' + DEP.NMDEPARTMENT 
                ELSE CAST(NULL AS VARCHAR(255)) 
            END AS ArespPlanoAcao
...
where aprov.cdapprov = max_cycle.cdapprov --and plano.CDACTIONPLANTYPE in (64)